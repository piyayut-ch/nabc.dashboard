  ...
  datatable(
    ...
    options = list(
      ...
      buttons = list(
        'copy', 
        'print', 
        list(extend = 'csv', filename = "oae_index"), 
        list(extend = 'excel', filename = "oae_index"))
    )
  ) %>%
    formatStyle(
    ...
    formatStyle(seq(1, n_cols, by = tf_num[[tf]]), `border-right` = "solid 1px")
}
